...
Alert-level values then override the effective defaults for each alert instance. This includes voice fields like `voice_proxies_enabled` and `voice_event_latch_secs`.
